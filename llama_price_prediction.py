...
def classify_sentiment(title):
    output = llm.invoke(f"Classify the sentiment of the following as either 'POSITIVE' or 'NEGATIVE' or 'NEUTRAL' using just that one word, using no additional words or reasoning: {title}")
    return output.strip()
...
ticker = st.sidebar.text_input("Enter stock ticker (e.g., SBUX):")

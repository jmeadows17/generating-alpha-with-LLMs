...
def get_news_data(ticker):
    ...
    # Apply classify sentiment to each row of news_df
    news_df['sentiment'] = news_df["Title"].apply(classify_sentiment)

    # Postprocess after LLM output
...
def process_sentiment_data(news_df):
    ...
    # Create rolling averages that count number of positive and negative sentiment articles with past t days
